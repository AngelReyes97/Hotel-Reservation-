    ...
    public partial class Form1 : Form
    {
        ...
        private void CollapseMenu()
        {
            ...
            {//Expands the Menu
                ...
                foreach (Button menuButton in panelMenu.Controls.OfType<Button>())
                {
                    Button menuButton1 = menuButton;
                    menuButton1.Text = "   " + menuButton.Tag.ToString();
        ...
        {
            title.Parent = pictureBox2;
            title.BackColor = Color.Transparent;
            homeHeader.Parent = pictureBox2;
            homeHeader.BackColor = Color.Transparent;
            homeDescription.Parent = pictureBox2;
            homeDescription.BackColor = Color.Transparent;
            wifilogo.Parent = pictureBox2;
            wifilogo.BackColor = Color.Transparent;
            roomservicelogo.Parent = pictureBox2;
            roomservicelogo.BackColor = Color.Transparent;
            hotelgym.Parent = pictureBox2;
            hotelgym.BackColor = Color.Transparent;
            noSmoking.Parent = pictureBox2;
        ...
        private void homeStartbtn_Click(object sender, EventArgs e)
        {
